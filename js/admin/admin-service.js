...
class AdminService {
    ...
    async exportToExcel() {
        try {
            ...
            const reportData = await ReportService.generateReport(this.currentFilter);
    ...
    renderAdminActivitiesTable(activities) {
        ...
        return activities.map(activity => `
            <tr data-activity-id="${activity.id}">
                ...
                <td>
                    <button class="btn btn-sm btn-outline-danger" onclick="adminService.removeActivityFromDay('${activity.id}')">
